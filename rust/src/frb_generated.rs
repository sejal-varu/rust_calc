...
fn wire_rust_calculate_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_exp = <String>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::calculator::rust_calculate(api_exp))
                })())
            }
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire_rust_calculate_impl(port, ptr, rust_vec_len, data_len),
